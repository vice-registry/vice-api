...
func configureAPI(api *operations.ViceAPI) http.Handler {
	...
	api.UpdateEnvironmentHandler = operations.UpdateEnvironmentHandlerFunc(func(params operations.UpdateEnvironmentParams, principal interface{}) middleware.Responder {
		...
		originalEnvironment, err := persistence.GetEnvironment(params.Body.ID)
		if err != nil {
			return operations.NewUpdateEnvironmentNotFound()
		}
		user := models.User(principal)
		if originalEnvironment.Userid != user.ID {
			return operations.NewUpdateEnvironmentUnauthorized()
		}
	...
	api.GetEnvironmentHandler = operations.GetEnvironmentHandlerFunc(func(params operations.GetEnvironmentParams, principal interface{}) middleware.Responder {
		...
		if err != nil {
			return operations.NewGetEnvironmentInternalServerError()
		}
	...
	api.UpdateImageHandler = operations.UpdateImageHandlerFunc(func(params operations.UpdateImageParams, principal interface{}) middleware.Responder {
		if principal == nil {
	...
	api.GetImageHandler = operations.GetImageHandlerFunc(func(params operations.GetImageParams, principal interface{}) middleware.Responder {
		if principal == nil {
			return operations.NewGetImageUnauthorized()
		}
		image, err := persistence.GetImage(params.ImageID)
		if err != nil {
			return operations.NewGetImageInternalServerError()
		}
	...
	// Deployment
	api.DeployImageHandler = operations.DeployImageHandlerFunc(func(params operations.DeployImageParams, principal interface{}) middleware.Responder {
		if principal == nil {
	...
	api.FindDeploymentsHandler = operations.FindDeploymentsHandlerFunc(func(params operations.FindDeploymentsParams, principal interface{}) middleware.Responder {
		if principal == nil {
	...
	api.GetDeploymentHandler = operations.GetDeploymentHandlerFunc(func(params operations.GetDeploymentParams, principal interface{}) middleware.Responder {
		if principal == nil {
	...
	api.DeleteDeploymentHandler = operations.DeleteDeploymentHandlerFunc(func(params operations.DeleteDeploymentParams, principal interface{}) middleware.Responder {
		if principal == nil {
