...
// UpdateImageParams contains all the bound params for the update image operation
...
func (o *UpdateImageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
